...
class AgentLinkTarget(A2ABaseModel):
    """
...
class LinkContext(A2ABaseModel):
    """
...
class AgentLinkContext(A2ABaseModel):
    """
...
class AgentCatalog(A2ABaseModel):
    """
